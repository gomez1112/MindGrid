...
extension Award {
    ...
    static let awards: [Award] = Bundle.main.decodeIfPresent("Awards.json") ?? []
    ...
    static var award: Award {
        awards.first ?? Award(name: "Sample", description: "", color: "", criterion: .sessions, value: 1, image: "rosette")
    }
}
